...
function Seven() {
    return (
        <section className="mt-3">
            ...
            <h1 className="text-center text-light text-decoration-underline mb-3">Class 7</h1>
            <div className="row">
                ...
                <div className="col-lg-3 col-md-6 mb-3">
                    <div className="card">
                        <div className="card-body">
                            <img src="../../images/Class7.jpg" className="img-fluid" alt="" />
                            <h5 className="card-title">All Subjects</h5>
                            <p className="card-text">NCERT Class 7 Textbooks - All Subjects English Medium (Set of 9 Books)</p>
                            <a href="" class="btn btn-primary">Buy Now</a>
                        </div>
                    </div>
                </div>
